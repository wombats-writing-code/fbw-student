  ...
  return (
    <div className="guide">
      <section className="splash-banner text-center flex-container align-center justify-center">
        <iframe width="100%" height="400" src="https://www.youtube.com/watch?v=zmFWxZcsxoY" frameborder="0" allowfullscreen></iframe>
      </section>
        ...
        <div className="row">
          <ol className="instruction-list">
            ...
            <li className="instruction">
              ...
              <div className="row">
                <img className="medium-7 columns" src={require("./assets/missions-3--accounting.png")}/>
              </div>
            </li>
            <li className="instruction">
              ...
              <div className="row">
                <img className="medium-6 columns" src={require("./assets/do-question-correct--accounting.png")}/>
              </div>
              ...
              <div className="row">
                <img className="medium-10 columns" src={require("./assets/do-question-1--accounting.png")}/>
              </div>
              <p>
                <b>Read the solution explanation</b>.
              </p>
              <div className="row">
                <img className="medium-8 columns" src={require("./assets/do-question-2--accounting.png")}/>
              </div>
              <p>
            ...
            <li className="instruction">
              ...
              <div className="row">
                <img className="columns" src={require("./assets/do-question-3--accounting.png")}/>
              </div>
            </li>
            <li className="instruction">
